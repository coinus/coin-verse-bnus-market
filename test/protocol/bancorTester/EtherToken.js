/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/EtherToken.js
...
const etherTokenTestCase = (artifact) => {
  const EtherToken = artifact
  const utils = require('./helpers/Utils')

  contract(`${artifact.contractName} is EtherToken`, accounts => {
