/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/SmartTokenController.js
...
const smartTokenControllerTestCase = (artifact) => {
  const SmartToken = artifacts.require('SmartToken.sol')
  // const SmartTokenController = artifacts.require('SmartTokenController.sol')
  const SmartTokenController = artifact
...
// initializes a new controller with a new token and optionally transfers ownership from the token to the controller
  ...
  contract(`${artifact.contractName} is SmartTokenController`, accounts => {
    before(async () => {
