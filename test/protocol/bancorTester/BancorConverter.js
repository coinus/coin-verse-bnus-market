/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/BancorConverter.js
...
const bancorConverterTestCase = (artifact) => {
  const fs = require('fs')
...
// used by purchase/sale tests
  ...
  contract(`${artifact.contractName} is BancorConverter`, accounts => {
    before(async () => {
