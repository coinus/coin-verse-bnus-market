/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/SmartToken.js
...
const smartTokenTestCase = (artifact) => {
  // const SmartToken = artifacts.require('SmartToken.sol')
  const SmartToken = artifact
  const utils = require('./helpers/Utils')

  contract(`${artifact.contractName} is SmartToken`, accounts => {
