/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/ContractRegistry.js
...
const contractRegistryTestCase = (artifact) => {
  // const ContractRegistry = artifacts.require('ContractRegistry.sol')
  const ContractRegistry = artifact
  ...
  contract(`${artifact.contractName} is ContractRegistry`, accounts => {
