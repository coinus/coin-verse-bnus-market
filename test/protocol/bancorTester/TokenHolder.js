/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/TokenHolder.js
...
const tokenHolderTestCase = (artifact) => {
  const TokenHolder = artifact
...
// initializes the holder with some ERC20 token balance
  ...
  contract(`${artifact.contractName} is TokenHolder`, accounts => {
