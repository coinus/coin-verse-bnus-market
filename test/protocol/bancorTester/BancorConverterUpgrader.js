/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/BancorConverterUpgrader.js
...
const bancorConverterUpgraderTestCase = (artifact) => {
  const fs = require('fs')
  ...
  const BancorConverterUpgrader = artifact
...
// The tests will be ran for each of these converter versions
  ...
  contract(`${artifact.contractName} is BancorConverterUpgrader`, accounts => {
    before(async () => {
...
module.exports = {
  bancorConverterUpgraderTestCase
}
