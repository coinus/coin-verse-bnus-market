/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/Whitelist.js
...
const whitelistTestCase = (artifact) => {
  // const Whitelist = artifacts.require('Whitelist.sol')
  const Whitelist = artifact
  const utils = require('./helpers/Utils')

  const invalidAccount = '0x0'

  contract(`${artifact.contractName} is `, 'Whitelist', accounts => {
