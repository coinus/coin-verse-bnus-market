/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/ERC20Token.js
...
const erc20TokenTestCase = (artifact) => {
  // const TestERC20Token = artifacts.require('TestERC20Token.sol')
  const TestERC20Token = artifact
  const utils = require('./helpers/Utils')

  const invalidAccount = '0x0'

  contract(`${artifact.contractName} is ERC20Token`, accounts => {
