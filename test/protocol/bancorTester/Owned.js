/**
 * Original test code:
 * https://github.com/bancorprotocol/contracts/blob/v0.4.4/solidity/test/Owned.js
...
const ownedTestCase = (artifact) => {
  const Owned = artifacts.require('Owned.sol')
  const utils = require('./helpers/Utils')

  contract(`${artifact.contractName} is Owned`, accounts => {
